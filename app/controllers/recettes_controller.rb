class RecettesController < ApplicationController
  ...
  def create
    ...
    unless params[:comment].nil?
      @comment = @recette.comments.new(content: params[:comment][:content],
  ...
  # Using a private method to encapsulate the permissible parameters is just a good pattern since you'll be able to
  # reuse the same permit list between create and update. Also, you can specialize this method with per-user
  # checking of permissible attributes.
  def recette_params
    params.require(:recette).permit({ category_ids: [] },
                                    :user_id,
                                    :ingredient,
                                    :instruction,
                                    :portion,
